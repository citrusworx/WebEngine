...
export const EDIT_CONTEXT = "edit" as const;
 ...
 */
export function withEditContext<T extends WordPressQuery = WordPressQuery>(
    query?: T
): T & { context: typeof EDIT_CONTEXT } {
    return { ...(query ?? ({} as T)), context: EDIT_CONTEXT };
}

/** Same as {@link withEditContext}. */
export function editContextQuery(query?: WordPressQuery): WordPressQuery {
