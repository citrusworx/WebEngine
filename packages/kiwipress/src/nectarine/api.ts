...
function readApiNode(value: unknown): ApiDefinition | null {
...
function walkNamedRoutes(
    resource: string,
    operation: string,
    named: unknown,
    routes: NectarineApiRoute[]
): void {
...
export function loadNectarineApi(data: YAMLdata | Record<string, unknown>): NectarineApiRoute[] {
    const root = asObject(data) ?? {};
    const routes: NectarineApiRoute[] = [];
...
export function loadNectarineApiFile(filepath: string): NectarineApiRoute[] {
