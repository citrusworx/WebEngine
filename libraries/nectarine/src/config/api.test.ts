    ...
    it("maps Blackwater productAPI.yml endpoint → path across CRUD", () => {
        ...
        expect(operations).toEqual([
            ...
            op({
                resource: "product",
                crud: "read",
                name: "payloadsWithKey",
                method: "GET",
                path: "/api/products/key/:key",
                query: "payloadsWithKey",
            }),
            op({
                resource: "product",
                crud: "read",
                name: "payloadsContaining",
                method: "GET",
                path: "/api/products/containing",
                query: "payloadsContaining",
            }),
            op({
                resource: "product",
                crud: "read",
