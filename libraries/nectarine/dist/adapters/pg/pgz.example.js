...
const pgz_1 = require("./pgz");
const workspaceRoot = process.cwd();
const schemaPath = node_path_1.default.resolve(workspaceRoot, 'apps/citrode/back/src/nectar/schema/schema.yml');
const sqlConfigPath = node_path_1.default.resolve(workspaceRoot, 'libraries/nectarine/schemas/user/db/pg/user.yml');
...
function buildCreateTableSQL(modelName, filepath) {
    const schema = util_1.parser.yaml(filepath);
...
async function example() {
    ...
    try {
        ...
        const getUserByIdConfig = util_1.parser.genSQL(sqlConfigPath, 'user', 'get', 'UserById');
        ...
        const newUserConfig = util_1.parser.genSQL(sqlConfigPath, 'user', 'create', 'NewUser');
...
void example();
//# sourceMappingURL=pgz.example.js.map