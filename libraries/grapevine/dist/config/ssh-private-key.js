...
export function sanitizeKeyFileName(name) {
 ...
 */
export function persistGeneratedPrivateKey(filePath, privateKeyPem) {
    ...
    try {
        ...
        const code = error && typeof error === "object" && "code" in error
            ...
            : undefined;
        if (code === "EEXIST") {
            throw new Error(`SSH private key already exists at ${filePath}; choose a different private_key_path or remove the file`);
        }
        throw error;
    }
...
//# sourceMappingURL=ssh-private-key.js.map