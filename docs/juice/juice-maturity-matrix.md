...
This document tracks the current maturity of Juice across its major system areas. It reflects the **0.9.0** public cut on npm (switch, slider, checkbox, radio, breadcrumb, and progress A→B→C). Master is ahead with the unpublished pagination runtime (theme chrome, runtime, and runtime / maturity docs). Menu is the twelfth Emerging auto-enhance runtime in 0.9.0. Switch is the thirteenth, slider is the fourteenth, checkbox is the fifteenth, radio is the sixteenth, breadcrumb is the seventeenth, and progress is the eighteenth. On master, pagination is the nineteenth. Checkbox and radio are two runtimes. Breadcrumb is a light trail. Progress is a progressbar. Pagination is a page set. Maturity ratings below stay **Emerging** — this pass does not bump anything to Stable-ish. 0.8.0 was the prior public cut.
