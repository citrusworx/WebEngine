...
- `Accordion()` is the only shipped Sig factory among the eighteen auto-enhance runtimes. Markup plus auto-enhance is still the contract. Checkbox and radio count as two of those runtimes. Breadcrumb is a light trail. Progress is a progressbar.
