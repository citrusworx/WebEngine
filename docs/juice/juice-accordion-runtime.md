...
- `Accordion()` is the only shipped Sig factory among the seventeen auto-enhance runtimes. Markup plus auto-enhance is still the contract. Checkbox and radio count as two of those runtimes. Breadcrumb is a light trail.
