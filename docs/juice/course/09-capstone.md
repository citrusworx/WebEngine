...
Keep behavior honest. A `<form>` that does not POST anywhere is fine if you say so. Juice’s nav/accordion/tabs/modal/drawer/toast/popover/wizard/tooltip runtimes are optional; they are not the grading surface.
