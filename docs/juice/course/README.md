...
Juice is an active alpha (`@citrusworx/juiceui` 0.9.0 in the [maturity matrix](../juice-maturity-matrix.md)). Lessons use shipped attributes and current theme contracts. Three labels keep that honest:
