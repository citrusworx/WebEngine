...
| `05-static-site-spaces.yaml` | Space + certificate + CDN | Space + CDN | Placeholders; does not upload `dist/` |
| `06-juice-static.yaml` | Juice template: hosting plus Vite build and Spaces sync | Space + CDN | Placeholders; CNAME still operator-owned |
